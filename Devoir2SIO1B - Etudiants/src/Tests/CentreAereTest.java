...
class CentreAereTest
{
    ...
    void ajouterEnfant()
    {
       ...
       boolean actual = centreAere.AjouterEnfant(enfant1,maison1,chambre1);
        assertEquals(expected,actual);


        // On ajoute l'enfant 2 à la maison 1,chambre 1
         expected = true;
         actual = centreAere.AjouterEnfant(enfant2,maison1,chambre1);
        assertEquals(expected,actual);

        // On ajoute l'enfant 3 à la maison 1,chambre 1
        expected = false;
        actual = centreAere.AjouterEnfant(enfant3,maison1,chambre1);
        assertEquals(expected,actual);
    }
